			...
			<table class="table" >
				...
				<tbody>
					<tr>
						...
						<td>Hotel Ariston</td>
						<td>JSFHIEEFJ45</td>
						<td><a href="modificaDatiCliente.jsp"> <i class="modifica fas fa-edit"></i></a>
						<td>
						<td>
							<div >
								<div class="form-group" >
									<button type="button" onclick="location.href='stock.jsp'"
										...
										class="btn stockPagMov">STOCK</button>

								</div>
								<div class="form-group" >
									<button type="button" onclick="location.href='pagamenti.jsp'"
										 
										class="btn stockPagMov">PAGAMENTI</button>
								</div>
								<div class="form-group">
									<button type="button" onclick="location.href='movimenti.jsp'"
										 
										class="btn stockPagMov">MOVIMENTI</button>
								</div>
							</div>
						<td>
					</tr>
