...
<body>
	...
	<div class="wrapper">
		...
		<div class="MyContainer">
					...
					<table class="table"
						...
						<tbody>
							<tr>
								...
								<td>15</td>
								<td><i style="color: red; font-size: 1.5em;"
			...
			<div class="row"
				style="margin-left: 5px; margin-bottom: 15px; border-bottom: 2px solid #E9EBED; width: 99%">
				<div class="col-sm-6">
					<p>Federe</p>
				</div>
				<div class="col-sm-4">
				...
				<div style="width: 100%;" id="demo1" class="collapse">
					<table class="table"
						style="background-color: #E9EBED; border-radius: 3px; width: 80%">
						<thead>
							<tr>
