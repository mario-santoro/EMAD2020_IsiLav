...
<body>
    ...
    <tbody>
      <tr>
        ...
        <td>
           <a href="confermaCliente.jsp"> <i style="color:red; font-size: 1.5em;" class="fas fa-trash-alt"></i></a>
      ...
      <tr>
        ...
        <td>Piazza Caduti di Brescia</td>
         ...
         <td>
        <i style="color:red; font-size: 1.5em;" class="fas fa-trash-alt"></i>
 	...
 	<button type="button" data-toggle="collapse" data-target="#demo"
						...
						class="btn btn-primary">AGGIUNGI HUB</button>
 
<div id="demo" class="collapse">
 <form action="gestioneHub.jsp" class="was-validated">
					<div class="form-group">
						<label for="reso">Città:</label> <input
					...
					<div class="form-group">
						<label for="ritardo">Via:</label> <input
							type="text" class="form-control" name="via"
							placeholder="Inserisci via" id="via"  required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">campo obbligatorio</div>
					</div>
					
					<button type="submit" 
						style="background-color: #70D0AE; border-color: #70D0AE;   "
