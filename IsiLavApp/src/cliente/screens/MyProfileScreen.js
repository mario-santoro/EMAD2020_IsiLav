                    ...
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <Text style={styles.baseTextBold}>Dati anagrafici:</Text>
                            <View style={{ flexDirection: "column", marginLeft:10 }}>
                                <Text style={styles.baseText}>Nome e Cognome: <Text style={styles.baseTextBold}>{cliente.nominativo}</Text></Text>
                                <Text style={styles.baseText}>Codice Fiscale: <Text style={styles.baseTextBold}>{cliente.codFiscale}</Text></Text>
                                <Text style={styles.baseText}>Ragione Sociale: <Text style={styles.baseTextBold}>{cliente.ragSociale}</Text></Text>
                                <Text style={styles.baseText}>Telefono: <Text style={styles.baseTextBold}>{cliente.telefono}</Text></Text>
                                <Text style={styles.baseText}>Nome attività: <Text style={styles.baseTextBold}>{cliente.nomeAttivita}</Text></Text>
                                <Text style={styles.baseText}>Sede: <Text style={styles.baseTextBold}>{cliente.sede}</Text></Text>
                                <Text style={styles.baseText}>Città: <Text style={styles.baseTextBold}>{cliente.citta}</Text></Text>
                                <Text style={styles.baseText}>CAP: <Text style={styles.baseTextBold}>{cliente.CAP}</Text></Text>
                                <Text style={styles.baseText}>P.IVA: <Text style={styles.baseTextBold}>{cliente.pIVA}</Text></Text>
                                <Text style={styles.baseText}>IFE: <Text style={styles.baseTextBold}>{cliente.IFE}</Text></Text>
                            </View>
                        </View>
                        <View style={{ flex: 2, justifyContent: "center" }}>
                            <Icon name="navigate-next" color="#E9EBED" size={50} ></Icon>
