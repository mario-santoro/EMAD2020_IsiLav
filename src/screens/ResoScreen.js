            ...
            <View>
                <FlatList
                    ...
                    renderItem={({item}) => (
                        ...
                        <ListItem.Title style={{color: "#3E4349"}}>In magazzino: <Text style={{fontWeight: 'bold'}}>{item.quantity}</Text></ListItem.Title>
                        </ListItem.Content>
                ...
                {selezionati.map(item =>
                    <View key={item.id} style={{flexDirection: 'row', alignItems:'center', width: "100%", marginVertical: 5, borderColor: "#9DE7CD", borderWidth: 1, padding: 2, borderRadius: 5, backgroundColor: "#F8FFFC"}}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                            ...
                            />
                            <Text style={{flex: 1, textAlign:'center', color: "#3E4349"}}>{item.quantity}</Text>
                            <Button
