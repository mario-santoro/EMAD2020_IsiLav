...
## Obiettivo
Lo scopo del progetto "IsiLav" è quello di realizzare un applicativo mobile, in React Native, che permetta ai clienti dell’azienda SNB srl di noleggiare comodamente i loro prodotti ritirandoli in hub stabiliti, inoltre una sezione corriere che tramite GPS segnalano ai clienti continuamente la loro posizione, e, con appositi RFID negli articoli, l'azienda entra nell'industria 4.0 con l'IoT.
Per la parte amministrativa invece verrà realizzato un applicativo web, in JAVA, che permetta la gestione e amministrazione dei clienti, delle forniture e di tenere traccia degli ordini ricevuti e gli eventuali ritardi sulle restituzioni da parte dei clienti.
Il tutto con il supporto e l'affidabilità dei servizi sul Cloud "Microsoft Azure".
